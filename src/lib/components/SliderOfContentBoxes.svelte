<script lang='ts'>
  ...
  let { contentBoxPropsArray = [] as ComponentProps<typeof ContentBox>[] }: { contentBoxPropsArray?: ComponentProps<typeof ContentBox>[] } = $props();
  ...
  const quintupledPropsArray = $derived([...contentBoxPropsArray, ...contentBoxPropsArray, ...contentBoxPropsArray, ...contentBoxPropsArray, ...contentBoxPropsArray]);
</script>
