    ...
    <ContentWidth class="flex flex-row pt-6 h-full py-32 md:py-6" >
        ...
        <div class="h-full w-1/4 flex flex-col gap-8">
            <div class="w-full flex flex-row h-6 gap-6 text-subtle-blue">
                <a href="https://www.linkedin.com/company/erp-industrials/" class="text-xl" aria-label="LinkedIn"><i class="fa-brands fa-linkedin-in"></i></a>
                <a href="https://www.facebook.com/ERPFunds/" class="text-lg translate-y-[-2px]" aria-label="Facebook"><i class="fa-brands fa-facebook-f"></i></a>
                <a href="https://www.loopnet.com/company/erp-industrials/midland-tx/9rvtzp4l/" class="scale-105"><img src={loopnet} alt="loopnet"/></a>
            </div>
            <a href="/contact">
        ...
        {:else}
            <div class="w-full h-full flex flex-col gap-8 justify-end relativve">
                ...
                <a href="https://tenantportal-erpfunds.securecafe3.com/newtenantportal/content2/login/?companyId=161" class="footer-link">TENANT PORTAL</a>
                <div class="w-full flex flex-row h-6 gap-6 text-subtle-blue">
                    <a href="https://linkedin.com" class="text-xl" aria-label="LinkedIn"><i class="fa-brands fa-linkedin-in"></i></a>
                    <a href="https://facebook.com" class="text-lg translate-y-[-2px]" aria-label="Facebook"><i class="fa-brands fa-facebook-f"></i></a>
